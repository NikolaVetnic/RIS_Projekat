...
<body>
	...
	<div class="main">
		<div class="header">
			<h2 class="title2 p-class">ADMIN : Ažuriranje admina</h2>
			<p class="p-class">Ulogovani ste kao : <span class="username p-class">${ user.username } </span></p>
		</div>
		
		<br />
		
		<form action="/api/v1/project/update/admins" method="post">
		...
		<span class="success">${ adminUpdateSuccessMsg }</span>
		<span class="error">${ adminUpdateMsg }</span>
