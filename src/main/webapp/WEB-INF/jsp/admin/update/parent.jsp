	...
	<div class="main">
		...
		<form action="/api/v1/project/update/parents" method="post">
			...
			<table>
				<tr>
					<td>Ime</td>
					<td><input type="text" name="firstName" value="${ parentToUpdate.firstName }" style="width: 390px" /></td>
				</tr>
				<tr>
					<td>Prezime</td>
					<td><input type="text" name="lastName" value="${ parentToUpdate.lastName }" style="width: 390px" /></td>
				</tr>
				<tr>
					<td>Lozinka</td>
