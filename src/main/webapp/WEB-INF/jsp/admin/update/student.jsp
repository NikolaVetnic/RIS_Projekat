...
<body>
	...
	<div class="main">
		...
		<form action="/api/v1/project/update/students" method="post">
		
			<table>
				<tr>
					<td>Ime</td>
					<td><input type="text" name="firstName" value="${ studentToUpdate.firstName }" style="width: 390px" /></td>
				</tr>
				<tr>
					<td>Prezime</td>
					<td><input type="text" name="lastName" value="${ studentToUpdate.lastName }" style="width: 390px" /></td>
				</tr>
				<tr>
					<td>Lozinka</td>
		...
		<span class="success">${ studentUpdateSuccessMsg }</span>
		<span class="error">${ studentUpdateMsg }</span>
