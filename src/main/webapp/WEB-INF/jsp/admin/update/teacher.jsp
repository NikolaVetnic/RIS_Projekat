...
<head>
<meta charset="UTF-8">
<title>Ažuriranje nastavnika</title>
...
<body>
	...
	<div class="main">
		<div class="header">
			<h2 class="title2 p-class">ADMIN : Ažuriranje nastavnika</h2>
			<p class="p-class">Ulogovani ste kao : <span class="username p-class">${ user.username } </span></p>
		</div>
		
		<br />
		
		<form action="/api/v1/project/update/teachers" method="post">
		
			<table>
				<tr>
					<td>Ime</td>
					<td><input type="text" name="firstName" value="${ teacherToUpdate.firstName }" style="width: 390px" /></td>
				</tr>
				<tr>
					<td>Prezime</td>
					<td><input type="text" name="lastName" value="${ teacherToUpdate.lastName }" style="width: 390px" /></td>
				</tr>
				<tr>
					<td>Lozinka</td>
		...
		<span class="success">${ teacherUpdateSuccessMsg }</span>
		<span class="error">${ teacherUpdateMsg }</span>
