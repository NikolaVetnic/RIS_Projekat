...
<head>
<meta charset="UTF-8">
<title>Registrovanje roditelja</title>
...
<body>
	...
	<div class="main">
		<div class="header">
			<h2 class="title2 p-class">ADMIN : Registrovanje roditelja</h2>
			<p class="p-class">Ulogovani ste kao : <span class="username p-class">${ user.username } </span></p>
		</div>
		
		<br />
		
		<form action="/api/v1/project/registration/parents" method="post">
			...
			<table>
				...
				<tr>
					<td>Email</td>
					<td><input type="text" name="email" style="width: 390px" /></td>
				</tr>
				<tr>
		...
		<span class="success">${ parentRegisterSuccessMsg }</span>
		<span class="error">${ parentRegisterMsg }</span>
