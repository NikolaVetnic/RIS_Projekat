...
<body>
	...
	<div class="main">
		<div class="header">
			<h2 class="title2 p-class">ADMIN : Registrovanje nastavnika</h2>
			<p class="p-class">Ulogovani ste kao : <span class="username p-class">${ user.username } </span></p>
		</div>
		
		<br />
		
		<form action="/api/v1/project/registration/teachers" method="post">
		...
		<span class="success">${ teacherRegisterSuccessMsg }</span>
		<span class="error">${ teacherRegisterMsg }</span>
